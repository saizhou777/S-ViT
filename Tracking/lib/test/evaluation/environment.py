...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.utb180_path = os.path.join(data_dir, 'utb180')
        self.vmat_path = os.path.join(data_dir, 'vmat')
        self.uavtrack112_path = os.path.join(data_dir, 'uavtrack112')
        self.davis_dir = ''
        self.youtubevos_dir = ''
