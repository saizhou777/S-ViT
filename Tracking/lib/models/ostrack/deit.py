...
def deit_small_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('deit_small_patch16_224_in21k', pretrained=pretrained, **model_kwargs)
    return model
...
def deit_tiny_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('deit_tiny_patch16_224_in1k', pretrained=pretrained, **model_kwargs)
    return model
