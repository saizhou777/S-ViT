...
#import models
#from RALA import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_DWConv import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_DWConv_no_attrope import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_DWConv_sparse_att import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_v1_token_recog import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_v2_rope import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L  
#from RALA_v2_token_pooling import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_v2_token_pooling import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_v3_pool_stage123_v4_2 import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_v3_pool_stage123_v5 import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_v4_stage23_v13 import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from RALA_v4_stage23_v13 import RAVLT_M, RAVLT_T, RAVLT_S, RAVLT_B, RAVLT_L
#from svit import SVIT_T, SVIT_S
#from csvit_rename import CSVIT_M, CSVIT_T, CSVIT_S, CSVIT_B
#from csvit_vb import CSVIT_M, CSVIT_T, CSVIT_S, CSVIT_B
#from csvit_series2 import CSVIT_M, CSVIT_T, CSVIT_S, CSVIT_B
from csvit_vb import CSVIT_XM, CSVIT_M, CSVIT_T, CSVIT_S, CSVIT_B
...
def get_args_parser():
    ...
    parser.add_argument('--local_rank', default=-1, type=int) # <--- 添加此行
