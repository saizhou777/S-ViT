...
#from models.backbones.ravlt_backbone import RAVLTBackbone
from models.backbones.svit_backbone import SVITBackbone
...
backbone = SVITBackbone(
    "svit_t", norm_layer=FrozenBatchNorm2d, return_indices=(1, 2, 3), freeze_indices=(0,)
)
