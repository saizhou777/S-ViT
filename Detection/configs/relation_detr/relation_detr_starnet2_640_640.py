...
from models.backbones.starnet_det2 import StarNetBackbone
...
backbone = StarNetBackbone(
    "starnet_s4", norm_layer=FrozenBatchNorm2d, return_indices=(1, 2, 3), freeze_indices=(0,)
)
